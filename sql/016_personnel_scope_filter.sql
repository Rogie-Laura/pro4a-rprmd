-- Scope personnel list by office + unit (station) for RHQ/PHQ/Station admins.
...
revoke execute on function public.list_personnel_rprmd_paged(text, text, text, int, int) from service_role;
